...
const FooterLayout = () => {
    ...
    return (
        <footer className="bg-gray-300 w-full p-10 mt-20">
            
            <hr className="my-6 border-default sm:mx-auto lg:my-8" />
            <div className="flex items-center justify-between">
                <span className="text-sm text-body sm:text-center">© {Fecha} <a href="https://flowbite.com/" className="hover:underline">APV</a>. All Rights Reserved.
                </span>
